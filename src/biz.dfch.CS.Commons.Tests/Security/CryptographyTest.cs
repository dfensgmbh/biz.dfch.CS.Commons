...
using biz.dfch.CS.Commons.Security;
using biz.dfch.CS.Testing.Attributes;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace biz.dfch.CS.Commons.Tests.Security
{
    [TestClass]
    public class CryptographyTest
    {
        ...
        public void NewCryptographyNullThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+password")]
        public void NewCryptographyEmptyThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+password")]
        public void NewCryptographyWhitespaceThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+password")]
        public void EncryptWhitespaceThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+plainText")]
        public void EncryptNullThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+plainText")]
        public void EncryptEmptyThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+password")]
        public void DecryptWhitespacePasswordThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+encryptedData")]
        public void DecryptNullThrowsContractException()
        {
        ...
        [TestMethod]
        [ExpectContractFailure(MessagePattern = "Precondition.+encryptedData")]
        public void DecryptEmptyThrowsContractException()
        {
