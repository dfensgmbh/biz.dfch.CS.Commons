...
{
    [TestClass]
    public class ConversionKeyAttributeTest
    {
        public const string StringPropertyWithAnnotationAnnotation = "biz.dfch.CS.Commons.ConversionKeyAttribute.StringPropertyWithAnnotation";
        public const string LongPropertyWithAnnotationAnnotation = "biz.dfch.CS.Commons.ConversionKeyAttribute.LongPropertyWithAnnotation";

        [TestMethod]
        public void StringPropertyWithAnnotation()
        {
            // Arrange, Act
            var sut = new Converters.ConversionKeyConverterTest.ClassWithConversionKeyAttributes();

            // Assert
            var propertyInfo = sut.GetType().GetProperty("StringPropertyWithAnnotation");
            Assert.IsNotNull(propertyInfo);

            var attribute = (ConversionKeyAttribute) Attribute.GetCustomAttribute(propertyInfo, typeof(ConversionKeyAttribute));
